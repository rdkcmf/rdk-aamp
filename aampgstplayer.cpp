...
struct AAMPGstPlayerPriv
{
	...
	AAMPGstPlayerPriv() : pipeline(NULL), bus(NULL), current_rate(0),
			...
			periodicProgressCallbackIdleTaskId(0),
			bufferingTimeoutTimerId(0), video_dec(NULL), audio_dec(NULL),TaskControlMutex(),firstProgressCallbackIdleTask("FirstProgressCallback"),
