...
private:
	/**
         ...
         */
	bool SendHelper(MediaType mediaType, const void *ptr, size_t len, double fpts, double fdts, double duration, bool copy, bool initFragment = 0,bool isLowLatencyMode=0);
	/**
         * @fn SendGstEvents
         * @param[in] mediaType stream type
...
public:
	...
	/**
         ...
         * @param[in] initFragment flag for buffer type (init, data)
         */
	void SendTransfer(MediaType mediaType, GrowableBuffer* buffer, double fpts, double fdts, double duration, bool initFragment,bool isLowLatencyMode=0);
	/**
