...
AAMPStatusType StreamAbstractionAAMP_HLS::Init(TuneType tuneType)
{
	...
	if (!this->mainManifest.len)
	{
		...
		(void) aamp->GetFile(aamp->GetManifestUrl(), &this->mainManifest, aamp->GetManifestUrl(), &http_error, &downloadTime, NULL, eCURLINSTANCE_MANIFEST_MAIN, true, eMEDIATYPE_MANIFEST,NULL,NULL,0,pCMCDMetrics);  //CID:82578 - checked return
