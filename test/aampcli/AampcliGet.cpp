	...
	if (sscanf(cmd, "get %s", command) == 1)
	{
		...
		else
		{
			switch(hash(command)){ // 1 based to zero based
				...
				case hash("currentPreferredLanguages"):
					{
