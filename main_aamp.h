...
public:
	...
	*/
	 ...
	 *   @return void
	 */
	virtual void SendTransfer( MediaType mediaType, struct GrowableBuffer* buffer, double fpts, double fdts, double duration, bool initFragment = false,bool isLowLatencyMode=0)= 0;
