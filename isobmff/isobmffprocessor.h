...
public:
	 ...
	 */
	IsoBmffProcessor(AampLogManager *logObj, class PrivateInstanceAAMP *aamp, IsoBmffProcessorType trackType = eBMFFPROCESSOR_TYPE_VIDEO, IsoBmffProcessor* peerBmffProcessor = NULL);
