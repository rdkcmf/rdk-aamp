...
int AampCCManagerBase::SetStatus(bool enable)
{
	...
	int ret = 0;
	mEnabled = enable;
	AAMPLOG_WARN("AampCCManagerBase::%s %d mEnabled: %d, mTrickplayStarted: %d, mCCHandle: %s",
				__FUNCTION__, __LINE__, mEnabled, mTrickplayStarted, (CheckCCHandle()) ? "set" : "not set");
